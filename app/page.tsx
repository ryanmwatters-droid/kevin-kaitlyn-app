      ...
      {showForm ? (
        <form onSubmit={save} className="bg-white border border-grey-soft/20 rounded-2xl p-4 mb-4 space-y-2">
          <input
            ...
            placeholder="What are we counting down to? (e.g. Save-the-dates)"
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const loadStats = async () => {
      const [tasksRes, guestsRes, msgRes, docsRes, budgetSettingsRes, budgetItemRes, vendorsRes, venuesRes] = await Promise.all([
